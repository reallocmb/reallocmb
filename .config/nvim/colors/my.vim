...
if &background ==# 'dark'
  ...
  hi Normal guifg=#dadada guibg=#161616 gui=NONE cterm=NONE
  ...
  hi Statement guifg=#ff00da guibg=NONE gui=NONE cterm=NONE
  hi Todo guifg=#00ffaf guibg=NONE gui=bold,reverse cterm=bold,reverse
  hi Type guifg=#8810ac guibg=NONE gui=bold cterm=NONE
